...
void CreditsState::Render(void)
{
	...
	font.DrawString("Developers:", 50, 650 + textMovement, 2, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Jordan Ness", 100, 750 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Jonathan Cox", 100, 800 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Conor Maloney", 100, 850 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Luis Garcia", 100, 900 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Michael Sciortino", 100, 950 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });

	font.DrawString("EP:", 50, 1050 + textMovement, 2, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("John Oleske", 100, 1150 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });

	font.DrawString("AP:", 50, 1250 + textMovement, 2, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Sean Hathaway", 100, 1350 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });

	font.DrawString("Artists:", 50, 1450 + textMovement, 2, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Caris Frazier", 100, 1550 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });
	font.DrawString("Gregory Bey", 100, 1600 + textMovement, 1, SGD::Color{ 255, 255, 130, 0 });
}
