...
public:
	...
	enum EntityType {
		ENT_BASE, ENT_SOLID_WALL, ENT_DOOR, ENT_BOSS_DOOR, ENT_UNIT, ENT_ENEMY, ENT_BOSS,
		ENT_BLOCK, ENT_TEMP_FREEZE, ENT_PERM_FREEZE, ENT_FROZEN, ENT_NOT_FROZEN, ENT_HAWK,
		ENT_FALLING_BLOCK, ENT_SPRAY,  ENT_SWITCH,
		ENT_PRESSURE_PLATE, ENT_MOVING_PLATFORM, ENT_STALACTITE,  ENT_DEATH,
		ENT_LEFT_RAMP, ENT_RIGHT_RAMP, ENT_ICE, ENT_ICE_LEFT_RAMP, ENT_ICE_RIGHT_RAMP, ENT_TURRET, ENT_BUZZSAW,
		ENT_ARMOR, ENT_HONOR,  ENT_PENDULUM, ENT_GEYSER, ENT_LAVA, ENT_TELEPORTER, ENT_JELLYFISH,
		ENT_BOSS_BULL, ENT_BOSS_CAVEMAN, ENT_BOSS_YETI, ENT_BOSS_CRAB, ENT_BOSS_WIZARD, ENT_WIZARD_HAWK, ENT_WIZARD_DASH, ENT_LASER, ENT_PROJ, ENT_SWORD, ENT_SQUID, ENT_POUNCER,
		ENT_BULL_ENEMY, ENT_SKELETON, ENT_MUTANT_MAN, ENT_MUTANT_BIRD, ENT_ICE_GOLEM, ENT_ICE_BAT, ENT_ICE_TURTLE,
		ENT_VOMIT, ENT_POOP, ENT_STATUE,  ENT_PLAYER,
	};
